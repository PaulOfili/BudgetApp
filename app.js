...
var budgetController = (function() {
    ...
    return {
        addItem: function(type, desc, val) {
            ...
            //Creates new ID, the next number after the ID of previous entry 
            
            ID = data.allItems[type].length === 0 ? 0 : data.allItems[type][data.allItems[type].length - 1].id + 1;

            //Checks if income or expenses and creates appropriate objects
            if(type == 'exp') {
            ...
            //Pushes the new object into the data structure
            data.allItems[type].push(newItem);

            //Returns the new created object or entry
            // console.log(data);
            return newItem;
        }, 
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var ctrlAddItem = function() {
        ...
        if (input.description !== "" && !isNaN(input.value) && input.value > 0) {
            //And clear allready existing fields
            UICtrl.clearFields();
